<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudToAdv.aspx.cs" Inherits="WebApplication1.StudToAdv" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Student to Advisor</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:TextBox runat="server" ID="advisorId" />
