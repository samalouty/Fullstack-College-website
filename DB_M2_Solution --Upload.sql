...
INSERT INTO Slot (slot_id,day, time, location, course_id, instructor_id) VALUES
(1, 'Monday', 'First', 'Room A', 1, 1),
(2, 'Tuesday', 'First', 'Room B', 2, 2),
(3, 'Wednesday', 'Third', 'Room C', 3, 3),
(4, 'Thursday', 'Fifth', 'Room D', 4, 4),
(5, 'Saturday', 'Second', 'Room E', 5, 5),
(6, 'Monday', 'Fourth', 'Room F', 6, 6),
(7, 'Tuesday', 'Second', 'Room G', 7, 7),
(8, 'Wednesday', 'Fifth', 'Room H', 8, 8),
(9, 'Thursday', 'First', 'Room I', 9, 9),
(10, 'Sunday', 'Fourth', 'Room J', 10, 10);
...
INSERT INTO GradPlan_Course(plan_id, semester_code, course_id) VALUES (1,'W23',3)
...
INSERT INTO Payment (payment_id,amount, startdate,n_installments, status, fund_percentage, student_id, semester_code, deadline)  VALUES
(1, 500, '2023-11-22', 1, 'notPaid', 50.00, 1, 'W23', '2023-12-22'),
(2, 700, '2023-11-23', 1, 'notPaid', 60.00, 2, 'S23', '2023-12-23'),
(3, 600, '2023-11-24', 4, 'notPaid', 40.00, 3, 'S23R1', '2024-03-24'),
(4, 800, '2023-11-25', 1, 'notPaid', 70.00, 4, 'S23R2', '2023-12-25'),
(5, 550, '2023-11-26', 5, 'notPaid', 45.00, 5, 'W23', '2024-04-26'),
(6, 900, '2023-11-27', 1, 'notPaid', 80.00, 6, 'W24', '2023-12-27'),
(7, 750, '2023-10-28', 2, 'Paid', 65.00, 7, 'S24', '2023-12-28'),
(8, 620, '2023-08-29', 4, 'Paid', 55.00, 8, 'S24R1', '2023-12-29'),
(9, 720, '2023-11-30', 2, 'notPaid', 75.00, 9, 'S24R2', '2024-01-30'),
(10, 580, '2023-11-30', 1, 'Paid', 47.00, 10, 'S24', '2023-12-31');
...
Update Student 
set financial_status =1 where student_id=1
...
INSERT INTO Payment
Values(1,100000,'2024-03-01', '2024-06-30', 2, 0, null, 1, 'S24');

SELECT * From Course

UPDATE Student_Instructor_Course_take
SET grade = 'F' where student_id = 1; 
